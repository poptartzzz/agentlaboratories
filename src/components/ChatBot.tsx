...
export default function ChatBot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: 'I am here to assist with setting up your AGENTZ bot. How can I help?' }
  ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const context = `You are the AGENTZ AI Assistant, helping users set up their bots. You have access to the following documentation:
        ...
        - Creating a bot requires a payment of $50 worth of AZI tokens
        - Price is dynamically calculated based on current AZI/USD rate
        ...
        Please provide a concise, accurate answer based solely on the information provided in the documentation. If the question is about something not covered in the documentation, politely indicate that.`;
